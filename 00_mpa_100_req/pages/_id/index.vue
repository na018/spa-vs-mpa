...
<script>
  ...
  export default {
    ...
    async asyncData ({query, error, route}) {
      ...
      let pageResArticles = await axios.get(`https://newsapi.org/v2/everything?q=single%20page%20application%20OR%20web&language=en&pageSize=100&page=${route.path.substr(1)}&apiKey=c48c38cca7494d35984f1ff77c28ef9d`) //  c48c38cca7494d35984f1ff77c28ef9d 9729fa4f21514bd9a8661bf8c5fd70e8
